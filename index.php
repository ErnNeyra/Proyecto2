            ...
            <nav class="flex items-center space-x-4 md:space-x-6">
                ...
                <?php
                    ...
                    if (isset($_SESSION['usuario'])) {
                        ...
                        // Si la ruta no empieza por 'php/', la anteponemos
                        if (strpos($imagenPerfil, 'php/') !== 0) {
                            $imagenPerfil = 'php/' . ltrim($imagenPerfil, '/');
                        }
                        ...
                        echo '        <img class="h-8 w-8 rounded-full mr-2 object-cover" src="php/' . htmlspecialchars($imagenPerfil) . '" alt="Imagen de Perfil de ' . $nombreUsuario . '">';
