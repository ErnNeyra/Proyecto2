...
<body class="bg-gray-100 font-sans min-h-screen flex flex-col">
    ...
    <main class="flex-grow">
        ...
        <section class="hero-section space-background text-white py-0 flex items-center relative overflow-hidden observe-section">
            <div class="stars"></div>
            <div class="twinkling"></div>
            <div class="container mx-auto px-4 text-center hero-content relative z-10">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight js-fade-in-up flex flex-col items-center justify-center gap-4" data-delay="0s">
                    Bienvenido a
