    ...
    <div class="bg-white rounded-md shadow-md p-8 max-w-lg mx-auto border border-gray-200">
        ...
        <form action="editar_servicio.php?id=123" method="post" enctype="multipart/form-data">
            <div class="mb-4">
                ...
                <input type="text" id="nombre" name="nombre" value="<?php echo $servicio["nombre"]?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div class="mb-4">
                <label for="descripcion" class="block text-gray-700 text-sm font-bold mb-2">Descripción:</label>
                <textarea id="descripcion" name="descripcion" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required><?php echo $servicio["descripcion"]?></textarea>
            </div>
            <div class="mb-4">
                <label for="precio" class="block text-gray-700 text-sm font-bold mb-2">Precio:</label>
                <input type="number" id="precio" name="precio" step="0.01" value="<?php echo $servicio["precio"]?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div class="mb-4">
                ...
                <p class="text-sm mt-2">Imagen actual: <a href="<?php echo $servicio["imagen"]?>" target="_blank" class="text-blue-500 underline">Ver imagen</a></p><!-- PROGRAMAR IMAGEN -->
            </div>
