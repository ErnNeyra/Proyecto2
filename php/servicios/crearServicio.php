<?php
   ...
   if (!isset($_SESSION['usuario'])) {
        ...
        header("location: ../usuarios/login.php"); // Corregir la ruta del login
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        //Valido la descripción del servicio
        ...
        //Valido la categoria del servicio
