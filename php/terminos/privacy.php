...
<body class="bg-gray-100 font-sans min-h-screen flex flex-col">
    ...
    <main class="container mx-auto py-12 px-6 flex-grow">
        <div class="bg-white rounded-lg shadow-md p-8">
            <h1 class="text-3xl font-semibold text-black mb-6 text-center">Política de Privacidad</h1>
                ...
                <ul class="list-disc pl-6 space-y-4">
                    <li>
                        ...
                        <ul class="list-disc pl-6">
                            <li>Recogemos información que nos proporcionas directamente al registrarte o usar nuestros servicios, como nombre, email, información de perfil, detalles de productos/servicios que publicas, etc.</li>
                            <li>También recogemos información automáticamente cuando usas la plataforma, como tu dirección IP, tipo de navegador, páginas visitadas, etc.</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="list-disc pl-6">
                            <li>No compartimos tu información personal con terceros, excepto cuando sea necesario para operar la plataforma, cumplir con la ley, o proteger nuestros derechos.</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Seguridad de los datos:</strong>
                        <ul class="list-disc pl-6">
                            <li>Implementamos medidas de seguridad para proteger tu información, pero ningún método de transmisión por Internet o almacenamiento electrónico es 100% seguro.</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Tus derechos:</strong>
                        <ul class="list-disc pl-6">
                            <li>Tienes derecho a acceder, corregir o eliminar tu información personal.</li>
                            <li>Puedes oponerte al procesamiento de tus datos o solicitar la limitación de su uso.</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Cambios a esta política:</strong>
                        <ul class="list-disc pl-6">
                            <li>Podemos actualizar nuestra Política de Privacidad ocasionalmente.</li>
                            <li>Te notificaremos cualquier cambio publicando la nueva política en esta página.</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Última actualización:</strong> 18 de mayo de 2025
                    </li>
                </ul>
            </div>
        </div>
