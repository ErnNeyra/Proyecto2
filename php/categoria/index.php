...
// Iniciar sesión (si es necesario, aunque esta página puede ser pública)
if (session_status() == PHP_SESSION_NONE) {
    session_start();
}

// Incluir archivos de utilidad (conexión BD y depuración) - Rutas relativas desde php/categoria/
require('../util/config.php'); // Necesitamos la conexión a BD
require('../util/depurar.php'); // Por si acaso
