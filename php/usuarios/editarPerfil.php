                ...
                <?php if (isset($_SESSION['usuario']['usuario'])): ?>
                    <div class="relative">
                        <button id="dropdownBtn"
                            class="text-gray-700 hover:text-black focus:outline-none flex items-center">
                        ...
                        <div id="dropdownMenu"
                            class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg origin-top-right hidden">
                            <div class="py-1">
                                <a href="panelUsuario.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Mi
                                    Panel</a>
                                <a href="logout.php" class="block px-4 py-2 text-red-500 hover:bg-gray-100">Cerrar
                                    Sesión</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="edit-profile-panel">
                ...
                <div class="flex justify-center items-center mb-6">
                    <img src="<?php echo htmlspecialchars($usuario['foto_perfil'] ?? '../util/img/usuario.png'); ?>"
                        alt="Foto de perfil" class="profile-image mx-auto mb-4 rounded-full w-32 h-32 object-cover shadow-lg">
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email"
                            ...
                            required pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Por favor, introduce un email válido"
                            class="focus:border-yellow-500 focus:ring-yellow-500">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="contrasena_actual" name="password_actual" required
                            class="focus:border-yellow-500 focus:ring-yellow-500">
                    </div>

                    <div class="form-group">
                        <label for="password_nuevo">Nueva Contraseña (dejar en blanco si no desea cambiarla):</label>
                        <input type="password" id="nueva_contrasena" name="password_nuevo"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="confirmar_contrasena" name="confirmar_password_nuevo"
                            class="focus:border-yellow-500 focus:ring-yellow-500">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="area_trabajo" name="area_trabajo"
                            ...
                            maxlength="100" class="focus:border-yellow-500 focus:ring-yellow-500">
                    </div>
